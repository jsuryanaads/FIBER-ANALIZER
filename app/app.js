...
$("addAsset")?.addEventListener("click",openAsset);$("addCable").onclick=()=>openCable();$("cableFrom").onchange=syncCablePorts;$("cableTo").onchange=syncCablePorts;$("search").oninput=renderAssets;
