...
function setupPage(){
 ...
 $("assetForm").onsubmit=saveAsset;$("cableForm").onsubmit=saveCable;$("mapForm").onsubmit=saveMap;$("stageForm").onsubmit=saveStage;$("tapForm").onsubmit=saveTap;$("outputForm").onsubmit=saveOutput;$("traceBtn").onclick=trace;$("traceCore").onchange=refreshTracePorts;
