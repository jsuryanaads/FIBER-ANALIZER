...
const dynamicAuthIds=new Set(["setupForm","setupUser","setupName","setupPass","setupPass2","loginForm","loginUser","loginPass","registerForm","registerEmail","registerName","registerUsername","registerOrg","registerPass","registerPass2","loginEmail","loginPass","userEmail"]);
